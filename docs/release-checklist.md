...
8. Deploy codox and javadoc to Github pages
    ...
    git clone https://github.com/wahpenayo/zana.git target/doc
    cd target/doc
    ...
    Run 
    ```
    clj src\scripts\clojure\wahpenayo\scripts\doc\codox.clj
    ```
    and 
    ```
    mvn javadoc:javadoc
...
[documentation](https://palisades-lakes.github.io/zana)
