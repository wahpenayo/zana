...
//----------------------------------------------------------------
/** Wrapper class that compares computed derivatives to numerical
 * estimates.
 * Assumes codomain is one dimensional.
 *
...
public final class GradientCheck extends Function {
  ...
  public final Function derivativeAt (final double x) {
    ...
    _out.println(_inner + " derivativeAt\n" + x + "\n= " + df  + "\n"); 
    _inner.checkGradient(new double[] {x},_out);
    return df; }
  ...
  public final boolean equals (final Object o) {
    ...
    return
      (o instanceof GradientCheck)
      &&
      _inner.equals(((GradientCheck) o)._inner)
      &&
      _out.equals(((GradientCheck) o)._out); }
  ...
  private GradientCheck (final Function inner,
                         final PrintWriter out) {
    super(inner.domain(),inner.codomain());
    _inner = inner;
    _out = out; }

  public static final GradientCheck wrap (final Function inner,
                                          final PrintWriter out) {
    return new GradientCheck(inner,out); }
